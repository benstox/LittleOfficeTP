...
\greannotation{1 {\upshape\Abar} VIII G}
...
\greannotation{2 {\upshape\Abar} IV c}
\gregorioscore[a]{latin/Ant2-01-laeva_ejus.gtex}
...
{\gresetinitiallines{0}
\gregorioscore[a]{latin/Ant2-02-laeva_ejus.gtex}
